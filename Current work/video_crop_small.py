...
# Change name of output video here
out = cv2.VideoWriter('video_crop(specific frame).mp4', fourcc, 30, desired_window_size)
...
while True:
    ...
    if ret:
        ...
        # This lines of code is to stop the crop up to a certain number of frames
        if frame_n_end == (frame_n_start + 300):
            break_flag = 1
            end = timer()
...
print('[INFO] number of frames start =', frame_n_start)
print('[INFO] number of frames end =', frame_n_end)
