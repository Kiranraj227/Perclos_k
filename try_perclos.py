...
for subject_number, bb_start in subject_list:
    ...
    base_folder = r'C:\Users\USER\PycharmProjects\Perclos_k\Current work\dlib_output'
    ...
    output_vid_name = r'dlib_output/' + subject_name + r'/dlib_' + subject_name + output_vid_number[vid_number]
    ...
    # out = cv2.VideoWriter('perclos_ori_bb.mp4', fourcc, 30, (desired_window_size[0], desired_window_size[1]))
    out = cv2.VideoWriter('perclos_ori_bb.mp4', fourcc, 30, (600, 600))
    ...
    while True:
        ...
        if ret:
            ...
            if detections[0][0][0][1] and (detections[0, 0, 0, 2]) > 0.4:
                ...
                for i in range(0, detections.shape[2]):
                    ...
                    cv2.rectangle(clone_img, (startX, startY), (endX, endY), (0, 0, 255), 2)
                    ...
                    landmarks = predictor(roi_gray,
                                          dlib.rectangle(startX - startX, startY - startY, endX - startX, endY - startY))
                    ...
                    clone_img[startY:endY, startX:endX] = roi_color
