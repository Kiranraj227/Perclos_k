...
# [TODO] Change the frontal face detector
    ...
    def assign_eye_close_open(self):
        ...
        while True:
            ...
            for face in faces:
                ...
                # [TODO] Determine suitable threshold for blinking, one of the paper used 0.3
                if blinking_ratio < 0.20:
                    ...
                    state = 'Open'
                # [TODO] Add perclos code here based on blink state
                '''
                From the bold guy tutorial
                vvvvv
                '''
