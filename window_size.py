...
# load dlib's CNN - MMOD face detector
...
while True:
    ...
    if ret:
        ...
        # faces_with_confidence = detector(gray, 1)
        # faces = [f.rect for f in faces_with_confidence]

        if faces:
            print("got face")
            # cropping the roi of face
            # [TODO] Only makes sense if one face detected, need to change to include multiple faces
            for face in faces:
            ...
            print("no face")
            no_face += 1
            x_start, x_end, y_start, y_end = old_startX, old_endX, old_startY, old_endY
        ...
        old_startX, old_endX, old_startY, old_endY = x_start, x_end, y_start, y_end
        # print(old_x_start, old_x_end, old_y_start, old_y_end)
