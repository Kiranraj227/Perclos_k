# Code to generate PERCLOS Dataset - opencv DNN + Dlib 68 landmarks
...
for subject_number, bb_start in subject_list:
    ...
    prototxt_path = 'E:\\Perclos_k_io\\Dependant files\\Opencv\\deploy.prototxt.txt'
    caffemodel_path = 'E:\\Perclos_k_io\\Dependant files\\Opencv\\res10_300x300_ssd_iter_140000.caffemodel'
    ...
    for vid_number in vid_list:
        ...
        output_vid_dir = r'opencv_dlib_output\\' + subject_name
        output_vid_name = output_vid_dir + r'\\opencv_dlib_' + subject_name + output_vid_number[vid_number]
        ...
        out_vid_name = "opencv_dlib_" + subject_name + output_vid_number[vid_number]
